...
public class FPSControllerPhysics : PortalTraveller
{
    public float walkSpeed = 3;
    public float runSpeed = 6;
    public float smoothMoveTime = 0.1f;

    public float movementDrag = 0.1f;

    public float maxAirSpeed = 6;

    public float inputAccelerationFactor = 6f;
    ...
    private void Update()
    {
        ...
        if(controller.isGrounded){
            maxSpeed = ((Input.GetKey(KeyCode.LeftShift)) ? runSpeed : walkSpeed);
