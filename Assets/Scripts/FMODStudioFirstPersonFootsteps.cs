...
public class FMODStudioFirstPersonFootsteps : MonoBehaviour
{
    ...
    {
        FMOD.Studio.EventInstance jumpLandEvent = FMODUnity.RuntimeManager.CreateInstance(GameSoundPaths.PlayerJumpLandSoundPath); 
        FMODUnity.RuntimeManager.AttachInstanceToGameObject(jumpLandEvent, _transform, GetComponent<Rigidbody>()); 
