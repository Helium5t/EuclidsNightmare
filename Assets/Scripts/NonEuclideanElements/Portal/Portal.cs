...
public class Portal : MonoBehaviour {
    ...
    void HandleTravellers () {
        ...
        for (int i = 0; i < trackedTravellers.Count; i++) {
            ...
            if (checkSide(portalSideOld,portalSide)) {
                ...
                //Debug.Log(transform.name+":Teleported traveller, removed from my list");
    ...
    void OnTravellerEnterPortal (PortalTraveller traveller) {
        if (!trackedTravellers.Contains (traveller)) {
            ...
            //Debug.Log(transform.name+":Added traveller to my list");
    ...
    void OnTriggerExit (Collider other) {
        var traveller = other.GetComponent<PortalTraveller> ();
        //if(traveller) Debug.Log(transform.name+":" + other.transform.name + " Exited");
        if (traveller && trackedTravellers.Contains (traveller)) {
            trackedTravellers.Remove (traveller);
            //Debug.Log(transform.name+":Removed traveller from my list");
