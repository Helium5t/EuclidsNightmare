...
public class FMODStudioFootstepsEditorTwo : Editor
{
    ...
    {
        // This method will display all of the default inspector serialized variables and fields we created inside the 'FirstPersonFootsteps' script whilst still allowing us to override the inspector and add new ones.
